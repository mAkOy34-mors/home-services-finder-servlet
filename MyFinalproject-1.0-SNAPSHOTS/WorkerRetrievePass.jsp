...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Change Password - Update Your Password</title>
    ...
    <body>
        ...
        if (errorMsg != null) {%>
            ...
            <% String emailNotFound = (String) request.getAttribute("InvalidUsername");
        if (emailNotFound != null) {%>
            ...
            <form id="changePasswordForm" action="WorkerChange" method="post">
        ...
        <script>
            ...
            form.addEventListener('submit', function (e) {
                ...
                if (!checkPasswordStrength(password.value)) {
                    ...
                    errorMessage.textContent = 'Password must meet security requirements!';
                    errorMessage.style.display = 'block';
                    isValid = false;
                }
