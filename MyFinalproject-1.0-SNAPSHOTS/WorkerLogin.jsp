...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Worker Login - Access Your Account</title>
    ...
    <body>
        ...
        <div class="navbar">
            <i class="fas fa-sign-in-alt"></i> Worker Login Portal
        </div>
        ...
        <div class="container">
            ...
            <form id="loginForm" action="WorkerLogin" method="post">
