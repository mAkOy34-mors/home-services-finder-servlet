...
<%
    ...
    if (deleteId != null && !deleteId.trim().isEmpty()) {
        try { 
            ...
            String deleteSql = "DELETE FROM PostJob WHERE id = ? AND userID = ?";
            PreparedStatement deleteStmt = conn.prepareStatement(deleteSql);
            deleteStmt.setInt(1, deleteRecordId);      // Record ID (integer)
            deleteStmt.setString(2, userId);           // User ID (varchar/string)
...
<head>
    <meta charset="UTF-8">
    <title>Manage Client Details</title>
    ...
    <style>
        * {
        ...
        .sidebar::-webkit-scrollbar {
            ...
            .sidebar a[href="ClientDeleteDetails.jsp"] {
   ...
   <div class="navbar">
            ...
            <div class="workers-grid">
                ...
                try {
                    ...
                    if (userId == null || userId.trim().isEmpty()) {
                        ...
                        String sql = "SELECT id, type, Description, Address, userID FROM PostJob WHERE userID = ?";
                        ...
                        while (rs.next()) {
                            ...
                            description = (description != null && !description.trim().isEmpty()) ? description : "No description provided";
                ...
                %>
                    <div class="no-workers">
                        ...
                        <p>You haven't posted a job yet. Start by creating your first client details.</p>
    ...
    <script>
        ...
        function deleteWorker() {
            if (workerIdToDelete) {
                window.location.href = 'ClientDeleteDetails.jsp?id=' + workerIdToDelete;
            }
        }
