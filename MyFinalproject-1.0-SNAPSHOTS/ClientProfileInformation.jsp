    ...
    <head>
        ...
        <style>
            * {
            ...
            .sidebar a[href="ClientProfileInformation.jsp"] {
    ...
    <body>
                ...
                <div class="workers-grid">
                    <%
                        try {
                            if (userId == null || userId.trim().isEmpty()) {
                                ...
                                String sql = "SELECT id, name, FirstName, LastName, password FROM userRegistration WHERE userID = ?";
                    ...
                    <div class="worker-card">
                        <div class="worker-header">
                            ...
                            <div>
                                <h3 style="color: #2d3748; margin-bottom: 5px;"><%= firstname%></h3>
                                <p style="color: #718096; font-size: 14px;">@<%= username%></p>
                            </div>
                        </div>
                    ...
                    <div class="no-workers">
                        ...
                        <p>You haven't created any profiles yet. Start by adding your first profile.</p>
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                <h3><i class="fas fa-edit" style="color: #4CAF50;"></i> Edit Your Profile</h3>
        ...
        <div id="deleteModal" class="modal delete-modal">
            <div class="modal-content">
                ...
                <p style="color: #718096; font-size: 14px; margin-top: 10px;">This action cannot be undone.</p>
                <div class="modal-buttons">
