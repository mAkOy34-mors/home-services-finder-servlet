        ...
        <style>
            ...
            * {
            ...
            @media (min-width: 769px) {
                .navbar.expanded {
                    padding-left: 70px; /* Reduced padding when sidebar is hidden */
                }
            }

            @media (max-width: 768px) {
                .navbar {
                    padding: 15px 20px 15px 70px; /* Fixed padding for mobile */
                }
            }
    ...
    <body>
                ...
                <div class="search-section">
                    ...
                    <div class="form-layout slide-up">
                        ...
                        <div class="form-illustration">
                            <img src="Images/JOB.webp" alt="Professional Workers" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="workers-grid">
                        ...
                        <div class="worker-card">
                            ...
                            <div class="worker-actions">
                                <form action="chat.jsp" method="get" style="margin: 0; flex: 1;">
                                ...
                                <button type="button" class="btn btn-outline btn-location" 
                                        onclick="toggleMap('<%= w[2]%>', 'map-<%= index%>', this)">
                                    <i class="fas fa-map-marker-alt"></i>
        ...
        <script>
                                    ...
                                    <div style="text-align: center; padding: 0.5rem;">
                                        <strong style="color: var(--primary);">Client Location</strong><br>
