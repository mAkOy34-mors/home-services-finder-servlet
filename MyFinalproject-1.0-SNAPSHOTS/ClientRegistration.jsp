...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Client Registration - Create Your Account</title>
    ...
    <body>
        ...
        <div class="navbar">
            <i class="fas fa-user-plus"></i> Client Registration Portal
        </div>
        ...
        <div class="container">
            ...
            <form id="registrationForm" action="ClientRegistration" method="post">
                <div class="form-grid">
