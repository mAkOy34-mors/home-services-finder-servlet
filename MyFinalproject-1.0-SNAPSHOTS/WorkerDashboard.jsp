...
<%@include file ="WorkerNotifications.jsp" %>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <body>
        <div class="navbar">
            ...
            <div class="search-container">
                <form action="SearchClient" method="post" style="margin: 0;">
                    <div class="search-bar">
                        <i class="fas fa-search search-icon"></i>
                        <input type="text" name="searchQuery" class="search-input" placeholder="Search client" value="<%= request.getParameter("searchQuery") != null ? request.getParameter("searchQuery") : ""%>">
        ...
        <div class="main">
            <div class="card">
                ...
                <p>Manage your job opportunities and connect with clients efficiently.</p>
            </div>

            <div class="card">
                <h3>Quick Tips</h3>
                <ul>
                    <li><strong>Register as a Worker</strong> — List your skills so clients can hire you.</li>
                    <li><strong>Find Available Jobs</strong> — Browse tasks posted by clients.</li>
                    <li><strong>Messages</strong> — Respond to clients, ask questions, and get updates on job status.</li>
                </ul>
            </div> 
        </div>
        ...
        <div class="modal-overlay" id="noWorkersModal">
            <div class="no-workers-modal">
                ...
                <p>We couldn't find any client matching your search criteria: "<strong id="searchQueryText"></strong>"</p>
                ...
                <div class="action-buttons">
                    ...
                    <a href="find_works.jsp" class="btn btn-secondary">
